...
class PursuitRunner(Runner):
    ...
    def run(self):
        ...
        for episode in range(episodes):
            ...
            for step in range(self.episode_length):
                ...
                data = obs, share_obs, np.expand_dims(rewards, -1), dones, infos, values, actions, action_log_probs, rnn_states, rnn_states_critic
    ...
    @torch.no_grad()
    def eval_for_fixed_episode_length(self, total_num_steps):
        ...
        for eval_step in range(self.episode_length):
            ...
            eval_episode_rewards.append(np.expand_dims(eval_rewards, -1))
    ...
    def render(self):
        ...
        for episode in range(self.all_args.render_episodes):
            ...
            if self.all_args.save_gifs:
                # print(envs.render('rgb_array').shape)
