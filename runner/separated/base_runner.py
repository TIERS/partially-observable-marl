...
class Runner(object):
    def __init__(self, config):
        ...
        if self.all_args.algorithm_name == "happo":
            from algorithms.happo.happo_trainer import HAPPO as TrainAlgo
            from algorithms.happo.policy import HAPPO_Policy as Policy
        elif self.all_args.algorithm_name == "hatrpo":
            from algorithms.hatrpo.hatrpo_trainer import HATRPO as TrainAlgo
            from algorithms.hatrpo.policy import HATRPO_Policy as Policy
        else:
