...
def parse_args(args, parser):
    ...
    parser.add_argument('--fix_agents', action='store_true', default=False, help="If set, freeze two agents to test the robustness.")
    parser.add_argument('--randomize_obs', action='store_true', default=False, help="If set, you will randomize the observations")
    parser.add_argument('--obs_range', type=int,
                        default=8, help="observation range")
...
def main(args):
    ...
    if not run_dir.exists():
        raise Exception('Please check the run_dir')
