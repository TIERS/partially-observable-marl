...
class Pursuit:
    def __init__(
        ...
        obs_space = spaces.Box(
            ...
            shape=(3, self.obs_range, self.obs_range),
            dtype=np.float32,
        )
    ...
    def step(self, action, agent_id, is_last):
        ...
        self.latest_reward_state = self.reward() # This is only the tag reward.
    ...
    def draw_model_state(self):
        ...
        for x in range(x_len):
            for y in range(y_len):
                ...
                pygame.draw.rect(self.screen, WHITE, pos, 1)
